...
Usage:
    HEXIUM_TOKEN=... python3 tools/publish-hexium.py dist/Sparring-0.1.0.zip \\
        --team isimp --categories "PvP,Mechanics,Open Source"

    python3 tools/publish-hexium.py dist/Sparring-0.1.0.zip --check-only
"""
