...
namespace Sparring
{
    [BepInPlugin(Guid, "Sparring", "0.1.0")]
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            _debugCommands = Rule("2 - Rules", "DebugCommands", false,
                "Enables the rehearsal and tuning commands: /duel spar, panels, testwin, testyield, testmessages, " +
                "testannounce, testsound, sounds, playsound and prefabs. Off by default because testwin and " +
                "testyield restore health. /duel preview is always available.");
